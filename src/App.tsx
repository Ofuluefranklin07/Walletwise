...
import { Wallet, LayoutDashboard, ReceiptText, Sparkles, Sun, Moon } from 'lucide-react';
...
export default function App() {
  ...
  return (
    <div className={`min-h-screen bg-indigo-50 dark:bg-slate-950 font-sans text-slate-900 dark:text-slate-100 transition-colors duration-300 border-4 md:border-8 border-indigo-100/50 dark:border-slate-900`}>
      {/* Header Section */}
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-10 h-20 md:h-24 flex flex-col md:flex-row items-center justify-center md:justify-between gap-4 md:gap-0 py-4 md:py-0">
          <div className="text-center md:text-left flex items-center gap-4">
            <div>
              ...
              <p className="hidden md:block text-indigo-400 dark:text-indigo-500 text-xs font-bold uppercase tracking-wider leading-none mt-1">Dashboard Overview</p>
            </div>
          </div>
